		...
		$('.gitcards').each(function() {
			...
			if (!repo) {
				...
				github_user(user, function(data) {
					...
					element.append('<div class="gc-user"><img src="' + data.avatar_url + '" /><p><span class="gc-nickname"><a href="https://github.com/' + data.login + '" target="_blank">' + data.name + '</a></span><span class="gc-login">' + data.login + '</span></p><ul>' + info + '</ul></div><div class="gc-status"><a href="https://github.com/' + data.login + '/followers"><strong>' + data.followers + '</strong><span>Followers</span></a><a href="https://github.com/' + data.login + '/following"><strong>' + data.following + '</strong><span>Following</span></a><a href="https://github.com/' + data.login + '?tab=repositories"><strong>' + data.public_repos + '</strong><span>Repositories</span></a></div>');
				});
			} else {
